#########################################################
CREATE PROCEDURE prcNotSupportedInAzure
AS
	RAISERROR('AmnE7001: This functionality is not supported in SQL Azure', 16, 1) 

#########################################################
CREATE PROCEDURE prcNotSupportedInAzureYet
AS
	RAISERROR('AmnE7002: This functionality is not yet converted to support SQL Azure', 16, 1) 
...
AS
	...
	BEGIN
		...
		CREATE  INDEX [uixndx1] ON [uix]([UserGUID], [ReportID], [SubID], [PermType])
	END
