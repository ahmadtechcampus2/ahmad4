...
as 
	...
	if exists(select * from [tempdb]..[sysobjects] where [name] = 'statements' and [xtype] = 'U') 
		delete [tempdb]..[statements] 
	else 
		create table [tempdb]..[statements]([statement] [NVARCHAR](max) collate arabic_ci_ai) 
